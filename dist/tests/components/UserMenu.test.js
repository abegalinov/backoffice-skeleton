...
describe('<UserMenu />', () => {
  it('can mount', () => {
    mount(React.createElement(UserMenu, null));
  });
  it('initial state set', () => {
    const wrapper = mount(React.createElement(UserMenu, null));
  ...
  it('logout works properly', () => {
    ...
    const wrapper = mount(React.createElement(UserMenu, {
      logoutProcess: logoutFunction
    }));
    wrapper.find(IconButton).simulate('click');
